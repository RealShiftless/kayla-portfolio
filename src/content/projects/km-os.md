...
title: "KM-Home"
slug: "km-home"
type: "Embedded QML home shell"
status: "Pre-alpha"
summary: "An embedded Qt/QML home shell for a media-box style Arch Linux setup, built around a C++ backend, QML shell UI, Wayland app surfaces, controller-friendly navigation, theming, settings, and app metadata."
...
KM-Home is an embedded QML home shell for a media-box style operating layer on top of Arch Linux. It is not trying to replace the whole operating system; it sits above the Linux base as a focused home screen for launching media, browser, and system-facing applications.
...
KM-Home uses Qt Quick for the shell UI and Qt Wayland compositor functionality for hosting external app surfaces. The main QML scene acts as the shell layer, with app views, overlays, controller hints, system pages, and brightness/settings surfaces living around the active application.
...
Planned additions include screenshots of the home shell, settings page, app launcher state, controller hints, theme variations, and an active app surface once final screenshots are selected.
